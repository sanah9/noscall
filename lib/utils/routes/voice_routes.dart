...
import 'package:noscall/voice_messages/voice_drafts_page.dart';
...
List<RouteBase> get voiceRoutes => [
  GoRoute(
    path: '/voice-drafts',
    builder: (context, state) => const VoiceDraftsPage(),
  ),
  GoRoute(
    ...
    builder: (context, state) {
      ...
      if (message == null) {
        return const Scaffold(body: Center(child: Text('Message not found')));
      }
