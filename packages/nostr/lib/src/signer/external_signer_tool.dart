...
import 'package:nostr/src/signer/signer_permission_model.dart';
...
class ExternalSignerTool {
  ...
  static Future<Map<String, String>?> signEvent(String eventJson, String id, String currentUser) async {
    final Object? result = await CoreMethodChannel.channelChatCore.invokeMethod(
      'nostrsigner',
      {
  ...
  ///sign_message
  static Future<Map<String, String>?> signMessage(String eventJson, String id, String currentUser) async {
    final Object? result = await CoreMethodChannel.channelChatCore.invokeMethod(
      'nostrsigner',
      {
  ...
  ///nip04_encrypt
  ///@return signature、id
  static Future<Map<String, String>?> nip04Encrypt(String plaintext, String id, String currentUser, String pubKey) async {
    final Object? result = await CoreMethodChannel.channelChatCore.invokeMethod(
      'nostrsigner',
      {
  ...
  ///nip44_encrypt
  ///@return signature、id
  static Future<Map<String, String>?> nip44Encrypt(String plaintext, String id, String currentUser, String pubKey) async {
    final Object? result = await CoreMethodChannel.channelChatCore.invokeMethod(
      'nostrsigner',
      {
  ...
  ///nip04_decrypt
  ///@return signature、id
  static Future<Map<String, String>?> nip04Decrypt(String encryptedText, String id, String currentUser, String pubKey) async {
    final Object? result = await CoreMethodChannel.channelChatCore.invokeMethod(
      'nostrsigner',
      {
  ...
  ///nip44_decrypt
  ///@return signature、id
  static Future<Map<String, String>?> nip44Decrypt(String encryptedText, String id, String currentUser, String pubKey) async {
    final Object? result = await CoreMethodChannel.channelChatCore.invokeMethod(
      'nostrsigner',
      {
  ...
  ///decrypt_zap_event
  ///@return signature、id
  static Future<Map<String, String>?> decryptZapEvent(String encryptedText, String id, String currentUser) async {
    final Object? result = await CoreMethodChannel.channelChatCore.invokeMethod(
      'nostrsigner',
      {
